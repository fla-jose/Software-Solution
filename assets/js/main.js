...
const linkAction = () =>{
     const navMenu = document.getElementById('nav-menu')
     // cuando hagamos click en cada nav__link, nosotros borraremos el show-menu class
     navMenu.classList.remove('show-menu')
}
...
const bgHeader = () =>{
    ...
    // Add a class if the bottom offset is grater than 50 of the viewport
...
const scrollUp = () =>{
  ...
  // when the scroll is higher than 350 view port height, add the
